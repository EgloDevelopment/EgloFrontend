import { sidebarState, sidebarPage, chatData } from "../states.jsx";
  ...
  return (
    <>
      <div className={showSidebar ? "show" : "hidden"}>
        <div className="fixed top-0 left-0 h-screen w-16 flex flex-col shadow-lg overflow-y-scroll hide-scrollbars bg-default-100 z-40 mt-14">
